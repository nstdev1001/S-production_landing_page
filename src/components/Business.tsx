  ...
  return (
    <Fragment>
      <div className="parent-container">
        <div className="product flex gap-5 items-center mt-20">
          <div
          ...
          <div className="text relative p-10">
            ...
            >
              ...
              factors, and strengths of the technology company while maintaining
              a cheerful, youthful vibe through the acting. The final product
              was a great success for both our partner and ourselves.
            </p>
          </div>
        </div>
      </div>
